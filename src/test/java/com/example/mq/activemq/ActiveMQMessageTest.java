...
public class ActiveMQMessageTest extends BaseActiveMQTest {
    ...
    public void testAsyncSend() throws InterruptedException {
        ...
        // 订阅消息
        mqFactory.getConsumer(MQTypeEnum.ACTIVE_MQ).subscribe(MQTypeEnum.ACTIVE_MQ, TOPIC, TAG, message -> {
        ...
        producer.asyncSend(MQTypeEnum.ACTIVE_MQ, TOPIC, TAG, event);
    ...
    public void testDelayMessage() throws InterruptedException {
        ...
        int delaySeconds = 3;
        producer.asyncSendDelay(MQTypeEnum.ACTIVE_MQ, TOPIC, TAG, event, delaySeconds);
    ...
    public void testMessageOrder() throws InterruptedException {
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            producer.syncSend(MQTypeEnum.ACTIVE_MQ, TOPIC, TAG, event);
        }

...
@Slf4j
public class RabbitMQMessageTest extends BaseRabbitMQTest {
    ...
    public void testAsyncSend() throws InterruptedException {
        ...
        // 订阅消息
        mqFactory.getConsumer(MQTypeEnum.RABBIT_MQ).subscribe(MQTypeEnum.RABBIT_MQ, TOPIC, TAG, message -> {
    ...
    public void testMessageOrder() throws InterruptedException {
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            producer.syncSend(MQTypeEnum.RABBIT_MQ, TOPIC, TAG, event);
        }
